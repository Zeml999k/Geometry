...
else{std::cout << "ERROR: Имя фигуры введено не правильно или пока что нету возможности нарисовать вашу фигуру.\n по всем вопросам пишите на почту разработчику: edbasov2020@mail.ru\n";}
